...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated {
    ...
    if ((g_IS_IPHONE_4_SCREEN) || (g_IS_IPHONE_5_SCREEN)) {
        //containerViewRect.origin.y = 20;
        containerViewRect.origin.y = 55;
    }
    else {
        containerViewRect.origin.y = 70;
    }*/
    ...
    if(self.showCloseButton){
        ...
        containerViewRect.origin.x = 165.0;
        containerViewRect.origin.y = 35.0;
    }
...
- (instancetype)init{
    if ((g_IS_IPHONE_4_SCREEN) || (g_IS_IPHONE_5_SCREEN)) {
        //if(!(self = [super initWithFrame:(CGRect){10, 10, 20, 20}])){
        //if(!(self = [super initWithFrame:(CGRect){5, 5, 30, 30}])){
        if(!(self = [super initWithFrame:(CGRect){280, 5, 30, 30}])){
            return nil;
        }
    }
    else {
        if(!(self = [super initWithFrame:(CGRect){5, 5, 50, 50}])){
            return nil;
        }
    }
    ...
    dispatch_once(&once, ^{
        ...
        if ((g_IS_IPHONE_4_SCREEN) || (g_IS_IPHONE_5_SCREEN))
            closeButtonImage = [UIImage imageNamed:@"btn_close_Info.png"];
        else
            closeButtonImage = [UIImage imageNamed:@"btn_close_Info.png"];   //btn_close_Info@3x.png
