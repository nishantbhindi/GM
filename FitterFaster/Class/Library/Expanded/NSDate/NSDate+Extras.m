...
- (NSUInteger)daysAgoAgainstMidnight
{
	...
	[mdf setDateFormat:g_DateFormatDefault];
...
{
	return [NSDate dateFromString:pstrDate withFormat:[NSDate dbFormatString]];
}
+ (NSDate *)dateFromString:(NSString *)pstrDate withFormat:(NSString *)pstrFormat {
	NSDateFormatter *inputFormatter = [[NSDateFormatter alloc] init];
	[inputFormatter setDateFormat:pstrFormat];
	NSDate *date = [inputFormatter dateFromString:pstrDate];
	[inputFormatter release];
	return date;
}
+ (NSString *)stringFromDate:(NSDate *)date withFormat:(NSString *)pstrFormat {
	return [date stringWithFormat:pstrFormat];
}
...
- (NSString *)stringWithFormat:(NSString *)pstrFormat {
	...
	[outputFormatter setDateFormat:pstrFormat];
...
+ (NSString *)dateFormatString {
	return g_DateFormatDefault;
}
+ (NSString *)timeFormatString {
	return g_TimeFormatFullDefault;
}
+ (NSString *)timestampFormatString {
	return g_DateTimeFormatDefault;
}
